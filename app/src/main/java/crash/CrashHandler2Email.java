...
public class CrashHandler2Email implements UncaughtExceptionHandler {

    private Thread.UncaughtExceptionHandler mDefaultHandler;// 系统默认的UncaughtException处理类
    private static CrashHandler2Email INSTANCE;// CrashHandler实例
    private Context mContext;// 程序的Context对象

    /**
     * 保证只有一个CrashHandler实例
     */
    private CrashHandler2Email() {
     ...
     */
    public static CrashHandler2Email getInstance() {
        if (INSTANCE == null)
            INSTANCE = new CrashHandler2Email();
        return INSTANCE;
    }
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            String[] tos = {"13767092838m@sina.cn"};
