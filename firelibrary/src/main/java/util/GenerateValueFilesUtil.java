...
public class GenerateValueFilesUtil {
    private int baseW;
    private int baseH;
    ...
    public GenerateValueFilesUtil(int baseX, int baseY, String supportStr) {
        this.baseW = baseX;
        this.baseH = baseY;
    ...
    public static void main(String[] args) {
        ...
        new GenerateValueFilesUtil(baseW, baseH, addition).generate();
    }
}
